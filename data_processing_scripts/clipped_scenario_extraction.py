...
class Scenario_Extractor:
    ...
    def extract_scenario(self,start_end_type='unix'):
        ...
        status = self.extract_gps(start_min, end_min, self.output_folder)
...
if __name__ =="__main__":
    ...
    output_folder = "/media/rtian2/New Volume/Jimmy/escooter_2024/data_preprocessed/sample_scenario_output2"
    ...
    for id,row in joystick_click_csv.iterrows():
        ...
        test_s = Scenario_Extractor(test_folder_dir, start, end, higher_output_folder=output_folder)
